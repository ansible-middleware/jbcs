...
The repository are:
 ...
 - [Flange demo](https://github.com/ansible-middleware/flange-demo)
   A deployment of Wildfly cluster integrated with jbcs and infinispan.
 - [CrossDC jbcs demo](https://github.com/ansible-middleware/cross-dc-rhsso-demo)
   A clustered multi-regional installation of jbcs with infinispan remote caches.
...
git clone https://github.com/ansible-middleware/jbcs
cd jbcs
...
EOF
# run the playbook
ansible-playbook -i inventory playbooks/jbcs.yml
```
